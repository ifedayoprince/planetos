...
; floppy for KERNEL.BIN (the PlanetOS kernel), loads it and executes it.
...
OEMLabel		db "PLANETBOOT"	; Disk label
...
VolumeLabel		db "PLANETOS     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; PlanetOS kernel filename
