...
; ==================================================================
	...
	%DEFINE PLANETOS_VER '1.3'	; OS version number
	%DEFINE PLANETOS_API_VER 3	; API version for programs to check
	%DEFINE PLANETOS_RELEASED '8/27/2020'	; Official release date of PlanetOS
...
; use a PlanetOS system call without having to know its exact position
...
option_screen:
	...
	os_init_msg		db 'Welcome to Planet OS', 0
	os_version_msg		db 'Version ', PLANETOS_VER, 0

	dialog_string_1		db 'Thanks for trying out Planet OS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute PlanetOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of PlanetOS, and', 0
