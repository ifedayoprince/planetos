; ------------------------------------------------------------------
; Minicom-like program for PlanetOS
; ------------------------------------------------------------------
...
;
; Connect the serial cable to your PlanetOS machine and Linux machine.
; Start PlanetOS and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the PlanetOS machine, you will see a
...
erase_sub:
	...
	start_msg	db 'PlanetOS minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting PlanetOS minicom; press a key to return to PlanetOS', 13, 10, 0
