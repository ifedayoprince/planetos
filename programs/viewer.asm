...
close:
	...
	png_extension	db 'PNG', 0

	err_string	db 'Please select a .TXT, .PCX or .PNG file!', 0

	title_msg	db 'PlanetOS File Viewer', 0
	footer_msg	db 'Select a .TXT, .PCX or .PNG file to view, or press Esc to exit', 0

	txt_title_msg	db 'PlanetOS Text File Viewer', 0
